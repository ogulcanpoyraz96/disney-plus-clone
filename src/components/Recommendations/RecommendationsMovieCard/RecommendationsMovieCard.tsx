...
import "./RecommendationsMovieCard.scss";

interface RecommendationsMovieCardProps {
  id: number;
  title: string;
  poster: string | null;
  watching: boolean;
...
const RecommendationsMovieCard: React.FC<RecommendationsMovieCardProps> = ({
  id,
  title,
  poster,
  watching,
...
export default RecommendationsMovieCard;
